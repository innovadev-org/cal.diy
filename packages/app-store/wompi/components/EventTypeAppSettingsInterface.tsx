...
import { WompiPaymentOptions as paymentOptions } from "../zod";
  ...
  return (
    <>
      ...
      <div className="mt-5 w-60">
        ...
        <Select
          data-testid="wompi-currency-select"
          variant="default"
      ...
      <div className="mt-4 w-60">
        ...
        <Select<Option>
          data-testid="wompi-payment-option-select"
          defaultValue={
